...
Module Type InterpreterStack_common (LP : LLVMParams) (MEM : Memory LP).
  ...
  (** Extract a [Z] from an L2 event whenever it is one of the events that
      ...
      MemoryE is at position 3, DebugE at position 8. *)
  ...
  Section InterpreterMCFG.
   ...
   This gives us a _vertical_ notion of compositionality.
    ...
    (** Like [interp_mcfg4_exec] but inserts [observe_L2] at L2 to collect
        Load/Store addresses and branch directions into the result. The
        observation list nests into the existing result tuple via [observe_L2]. *)
