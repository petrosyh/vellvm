...
do
    ...
    perl -i -pe "s/let gen_float32_syntax =/let gen_float32_syntax : LLVMAst.float_syntax coq_GenALIVE2 =/" $EXTRACT_DIR/$f
    perl -i -pe "s/let gen_double_syntax =/let gen_double_syntax : LLVMAst.float_syntax coq_GenALIVE2 =/" $EXTRACT_DIR/$f        
